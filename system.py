        ...
        try:
            ...
            ## see http://blog.zx2c4.com/699 for a solution that might work
                ...
                if first_run:
                    ...
                    args0 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVGA-1/workspace0/last-image", "-s", file_loc]
                    args1 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVGA-1/workspace0/image-style", "-s", "5"] # 5 == zoomed
                    args2 = ["xfconf-query", "-c", "xfce4-desktop", "-p", "/backdrop/screen0/monitorVGA-1/workspace0/image-show", "-s", "true"]
